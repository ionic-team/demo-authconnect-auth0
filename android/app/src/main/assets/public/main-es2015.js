...
let AuthGuard = class AuthGuard {
    constructor(authentication, navCtrl) {
        this.authentication = authentication;
        this.navCtrl = navCtrl;
    }
    canActivate() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            const authed = yield this.authentication.isAuthenticated();
            if (authed) {
                return true;
            }
            else {
...
AuthGuard = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"],
...
module.exports = __webpack_require__(/*! /Users/matt/Documents/src/ionic/demo-apps/demo-authconnect-auth0/src/main.ts */"zUnb");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "auth0NativeConfig", function() { return auth0NativeConfig; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "auth0WebConfig", function() { return auth0WebConfig; });
const environment = {
    production: false
};
const auth0NativeConfig = {
    // the auth provider
    authConfig: 'auth0',
...
/* harmony import */ var _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @capacitor/status-bar */ "cnT8");
...
let AppComponent = class AppComponent {
    ...
    initializeApp() {
        if (_capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Capacitor"].isNativePlatform()) {
            _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_5__["StatusBar"].setStyle({ style: _capacitor_status_bar__WEBPACK_IMPORTED_MODULE_5__["Style"].Light });
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
/* harmony import */ var _ionic_enterprise_auth__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @ionic-enterprise/auth */ "99Iy");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "tyNb");
/* harmony import */ var _capacitor_core__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @capacitor/core */ "FUe0");
...
let AuthenticationService = class AuthenticationService extends _ionic_enterprise_auth__WEBPACK_IMPORTED_MODULE_2__["IonicAuth"] {
    constructor(router) {
        // Determine whether to run on mobile or the web
        const selectedConfig = _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Capacitor"].isNativePlatform() ? _environments_environment__WEBPACK_IMPORTED_MODULE_5__["auth0NativeConfig"] : _environments_environment__WEBPACK_IMPORTED_MODULE_5__["auth0WebConfig"];
        super(selectedConfig);
        this.router = router;
    }
    getUserInfo() {
        const _super = Object.create(null, {
            getIdToken: { get: () => super.getIdToken }
        });
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return yield _super.getIdToken.call(this);
        });
    }
    onLoginSuccess() {
...
const routes = [
    ...
    { path: 'home', loadChildren: () => __webpack_require__.e(/*! import() | home-home-module */ "home-home-module").then(__webpack_require__.bind(null, /*! ./home/home.module */ "ct+p")).then(m => m.HomePageModule), canActivate: [_services_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]] },
